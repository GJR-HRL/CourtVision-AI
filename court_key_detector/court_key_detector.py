...
# We used Pose detector because 
# - A court cannot be detected as a single box.
# - A court must be reconstructed using multiple keypoints(rely on other points).
# - Only a pose/keypoint model provides those.

class CourtKeyDetector:
    """
    ...
    def get_court_keypoints(self, frames,read_from_stub=False, stub_path=None):
        ...
        Args:
            ...
            read_from_stub (bool, optional): Indicates whether to read keypoints from a stub file instead of running the detection model. Defaults to False.
