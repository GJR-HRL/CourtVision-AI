...
class SpeedAndDistancePlotter():
    """
        plots the speed and distance below the player
    """
    def __init__(self):
        pass 
    def plot(self, video_frames,player_tracks,player_distances_per_frame,player_speed_per_frame):
        output_video_frames = []
        total_distances = {}
