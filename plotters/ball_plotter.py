...
class BallTracksPlotter:
    """
    A plotter class responsible for drawing ball tracks on video frames.
    ...
    def plot(self, video_frames , tracks):
        """
        ...
        for frame_num , frame in enumerate(video_frames):
            # Make a Copy as value not refrence 
            frame = frame.copy()
