...
class TopViewPlotter:
    def __init__(self, team_1_color=[255, 245, 238], team_2_color=[128, 0, 0]):
        # x position of top view image
        self.start_x = 20
        # y position of top view image
        self.start_y = 40
    ...
    def plot(self, 
        ...
        Args:
            ...
            tactical_player_positions (list, optional): List of dictionaries mapping player IDs to their positions in tactical view coordinates.
        ...
        for frame_idx, frame in enumerate(video_frames):
            ...
            # Draw player positions in top/tactical view if available
