...
class CourtKeypointPlotter:
    ...
    def plot(self, frames, court_keypoints):
        """
        ...
        Args:
            ...
            court_keypoints (list): A corresponding list of lists where each sub-list contains the (x, y) coordinates of court keypoints for that frame.
