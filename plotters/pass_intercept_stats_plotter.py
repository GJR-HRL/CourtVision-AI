...
class PassInterceptionPlotter:
    """
    A class responsible for calculating and drawing pass and interception statistics on a sequence of video frames.
    """
    ...
    def get_stats(self,passes,interceptions):
        ...
        # zip combines the 1 element of passes and interceptions 
        # enmerate gives frame index and list of combined passes and interceptions
    ...
    def plot_frame(self, frame, frame_num, passes, interceptions):
        """
    ...
    def plot(self, video_frames, passes, interceptions):
        """
        ...
        for frame_num ,frame in enumerate(video_frames):
            frame_drawn = self.plot_frame(frame,frame_num,passes,interceptions)
